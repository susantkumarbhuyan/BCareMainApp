...
public class BookStoreEnvironment implements Environment {
	private static final String MONGODB_HOST = "localhost";
	private static final int MONGODB_PORT = 27017;
	private static final String MONGODB_DATABASE = "bookstore";
	private static final long BRAND_ID = BrandConstants.BRAND_ID_BOOKSTORE; // BRAND_ID_BCARE
